...
import type { Claim, Patient } from '../api/types'

vi.mock('../api/client', async (importOriginal) => {
  const actual = await importOriginal<typeof import('../api/client')>()
  return {
    ...actual,
    api: { ...actual.api, listPatients: vi.fn(), createClaim: vi.fn(), searchMedicalCodes: vi.fn() },
  }
})
...
const CREATED: Claim = {
  ...
  totalChargeAmount: 150, createdBy: 'u1', createdAt: '2026-01-10T10:00:00Z', version: 0, lines: [],
}
