...
- **Next:** slice 6 — evidence pack (`docs/evidence/`) + resume bullets (relaunch observability on-demand for
  dashboard screenshots). Optional follow-up: the 6 deferred ADRs (006/007/008/012/013/017).
