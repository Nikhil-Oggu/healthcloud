...
### 2026-09-24 — Phase 12 slices 1–4: validation + README + diagrams + threat model ✅ (portfolio)
...
- **Files:** `README.md` (rewritten + doc-index links), `docs/architecture/architecture.md` (new),
  `docs/er-diagram/er-diagram.md` (new), `docs/threat-model/threat-model.md` (new), `docs/PROGRESS.md`.
...
- **Next:** slice 5 — remaining ADRs (bring `docs/adr/` up from the current 4 toward the decisions actually made).
