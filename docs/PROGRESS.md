...
### 2026-09-24 — Phase 12 slices 1–3: validation + README case study + architecture & ER diagrams ✅ (portfolio)
...
- **Files:** `README.md` (rewritten + doc-index links), `docs/architecture/architecture.md` (new),
  `docs/er-diagram/er-diagram.md` (new), `docs/PROGRESS.md`. No app/behavior change.
...
- **Next:** slice 4 — threat model into `docs/threat-model/` (STRIDE-style over the real boundaries).
