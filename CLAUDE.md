...
- **Pagination + filtering + sorting (§Phase 9):** every work-queue list endpoint is **server-side paged** and
  ...
  prior-auth, referrals, appeals, claim-reviews, reprocessing, audit, dead-letters). Reserved for later Phase 9:
  free-text search, CSV export with masking, WCAG 2.2 AA.
